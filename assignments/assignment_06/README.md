...
### Task 4 — Flye 2.9.6 conda - miniforge 3 loaded, mamba for install, conda for activating, exports environment & creates flye-env.yml
```bash
...
### Task 9 — cleared all output directories and env and reran pipeline
